...
st.markdown("""
    ...
    /* 🎨 FUNDO ROSA COM ESTAMPA DE TRANÇAS NA COR PRETA */
    .stApp {
    ...
    /* ESTILO PADRÃO DOS BOTÕES DE MENU */
    div.stButton > button {
        width: 100% !important;
        background-color: #ffffff;
        color: #e05297;
    ...
    @media screen and (max-width: 768px) {
        ...
        div[data-testid="stColumn"] {
            ...
            width: 16.6% !important; /* Ajustado para 6 colunas */
        }
        ...
        div.stButton > button {
            ...
            font-size: 0.58rem !important; /* Reduzido levemente para caber 6 botoes no celular */
...
# 5. Menu Superior Padronizado (Agora com 6 colunas)
...
if pagina == "📖 Catálogo":
    ...
    st.markdown("""
        <div class="content-card">
            ...
            <hr style="border: 0.5px solid #fce4ec; margin: 10px 0;">
            
            <p style="color: #333; font-weight: 600; margin-bottom: 4px;">🏠 Endereço Completo:</p>
            <p style="color: #555; font-size: 0.95rem; margin-bottom: 12px;">
                Rua Exemplo das Tranças, nº 123 - Bairro Central<br>
                Campinas - SP | CEP: 13000-000
            </p>
            
            <p style="color: #333; font-weight: 600; margin-bottom: 4px;">💡 Ponto de Referência:</p>
            <p style="color: #555; font-size: 0.9rem; margin-bottom: 15px;">
                Próximo ao Supermercado Principal / Em frente à Praça da Matriz.
            </p>
            
            <!-- Botões Rápidos para GPS -->
            <div style="display: flex; gap: 10px; margin-bottom: 15px; flex-wrap: wrap;">
                <a href="https://maps.google.com" target="_blank" style="flex: 1; min-width: 140px; text-decoration: none;">
                    <div style="background-color: #e05297; color: white; text-align: center; padding: 10px; border-radius: 12px; font-weight: 600; font-size: 0.85rem;">
                        🗺️ Abrir no Google Maps
                    </div>
                </a>
                <a href="https://waze.com" target="_blank" style="flex: 1; min-width: 140px; text-decoration: none;">
                    <div style="background-color: #333333; color: white; text-align: center; padding: 10px; border-radius: 12px; font-weight: 600; font-size: 0.85rem;">
                        🚗 Abrir no Waze
                    </div>
                </a>
            </div>
            ...
            <div style="width: 100%; border-radius: 14px; overflow: hidden; border: 1px solid #f2c4ce;">
                <iframe 
                    width="100%" 
                    height="280" 
                    frameborder="0" 
                    ...
                    marginheight="0" 
                    marginwidth="0" 
                    src="https://maps.google.com/maps?q=Campinas%20SP&t=&z=13&ie=UTF8&iwloc=&output=embed">
                </iframe>
            </div>
        </div>
    """, unsafe_allow_html=True)
...
# 7. Rodapé Discreto em Todas as Páginas
st.markdown("""
